...
```
# E
```{r , matrizCorrelacion, echo = FALSE}
cor_pearson <- cor(icfes_corr[, vars_puntajes], method = "pearson")
cor_pearson
```
# F
```{r , MatrizSpearman, echo = FALSE}
...
cor_spearman <- cor(cbind(vars_ordinales_num, icfes_corr[, vars_puntajes]),
                    method = "spearman")
cor_spearman
```
# G
```{r , MatrizKendall, echo = FALSE}
cor_kendall <- cor(cbind(vars_ordinales_num, icfes_corr[, vars_puntajes]),
                   method = "kendall")
cor_kendall
```
# H
```{r , HeatmapCorrelaciones, echo = FALSE}
